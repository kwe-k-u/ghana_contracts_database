  ...
  <footer class="cs-primary center">
		...
		<div class="row align-items-start">
			...
			<div class="col">
				...
				<ul>
					...
					<li>
						<a href="contract_search.php?status=abandoned" class ="footer-link">Abandoned Projects</a>
					</li>
					...
					<li>
						<a href="contract_search.php?status=proposed" class ="footer-link">Proposed Projects</a>
					</li>
				</ul>
	...
	<p class="text-center"> Built and maintained by Duala Inc <a>Report a problem</a></p>
